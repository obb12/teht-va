...
<html lang="en">
    ...
    <head>
        <title>Kolme Laattikkoa</title>
        <meta charset="utf-8">
		<link rel="icon" href="http://opiskelu.businesscollege.fi/favicon.ico">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link rel="stylesheet" href="layout.css">
    </head>
    <body>
	
	<section id="eka"><figure id="huomio">Q</figure>
	<h2>How does one punch out the corner of an element and put something in the space created? </h2>
	<p>
Answer: you don't, at least not structurally. But the appearance can be achieved very easily just by using floated elements and, when necessary, some tiny negative margins. In this example, I've wrapped the "Q" in a div of its own and then floated the div over. Then I give the float some nice padding and margins, and center the character. Finally, I set thick white borders on the float, which matches nicely with the white document background-- but only the right and bottom borders are made thick. The top and left borders are set to zero. To wit: </p>
   ...
   <pre>div#punch {
float: left; font-size: 500%; width: 1.2em;
...
div#punch2 img {height: 70px; width: 100px;}</pre>
   <p>
...
border-width: 1px 0 1px 1px; margin: 0.2em -1px 0.2em 0.5em;}</pre>
<p>Note that, due to rounding errors, Mozilla (and thus Netscape 6.x) may not move a right-floated element over as far as it should be. If you resize your browser window enough times, you'll see a black border appear to the right of the pull quote. That's because the float is one pixel too far to the left, and the main div's border becomes visible. Hopefully they'll fix that eventually. </p>

<p>There are any number of ways this concept could be extended, really. The only limit is your imagination! And negative margins don't have to be restricted to floats, either. Consider this fairly irregular-looking page and how it's been created. Some floats, some normal-flow elements, a few one-pixel negative margins, and you've got some twisty layouts! I just hope Wired doesn't sue me for stylistic theft... </p>

<p>Jump to</p>
<ul>
	<li>
		<a href="#eka" hreflang="en">
			css/edge home
		</a>
	</li>
	<li>
		<a href="#kolmas" hreflang="en">
			boxpunch 2 
		</a>
	</li>
	<li>
		<a href="#ie" hreflang="en">
			boxpunch-IE
		</a>
	</li>
</ul>
